      ...
      <Card className="Card">
        <Card.Content>
          ...
          <Card.Description className="cardDescription">
            This small quiz is used to categorize students and send them to the
            Super class. There will be a total of 20 questions. We assign 5
            points to each question. So, 75 points is the pass limit to join
            Super class.
